module Cardano.Tracer.Handlers.RTView.State.Resources
  ( ResourcesState
  , SavedResources (..)
  , initResourcesState
...
data SavedResources = SavedResources
  { cpuLastTicks :: !Integer
  , cpuLastNS    :: !Word64
  }

type ResourcesState = TVar (Map NodeId SavedResources)

initResourcesState :: IO ResourcesState
initResourcesState = newTVarIO M.empty
